...
function ejecutarDemo(sistema: SistemaEstudiantes): void {
    ...
    console.log("\n=== AGREGANDO 3 ESTUDIANTES ===");

    console.log(
        sistema.agregar(new Estudiante(1, "Carlos", 20, "Sistemas", true, 8.5))
    );

    console.log(
        sistema.agregar(new Estudiante(2, "Ana", 22, "Administración", true, 9.2))
    );
